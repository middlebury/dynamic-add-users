    ...
    */
    public function getMaintenanceWindowStartTime()
    {
        if (array_key_exists("maintenanceWindowStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["maintenanceWindowStartTime"], "\Beta\Microsoft\Graph\Model\TimeOfDay") || is_null($this->_propDict["maintenanceWindowStartTime"])) {
    ...
    */
    public function getMiracastChannel()
    {
        if (array_key_exists("miracastChannel", $this->_propDict)) {
            if (is_a($this->_propDict["miracastChannel"], "\Beta\Microsoft\Graph\Model\MiracastChannel") || is_null($this->_propDict["miracastChannel"])) {
    ...
    */
    public function getWelcomeScreenMeetingInformation()
    {
        if (array_key_exists("welcomeScreenMeetingInformation", $this->_propDict)) {
            if (is_a($this->_propDict["welcomeScreenMeetingInformation"], "\Beta\Microsoft\Graph\Model\WelcomeScreenMeetingInformation") || is_null($this->_propDict["welcomeScreenMeetingInformation"])) {
