    ...
    */
    public function getFinal()
    {
        if (array_key_exists("final", $this->_propDict)) {
            if (is_a($this->_propDict["final"], "\Beta\Microsoft\Graph\Model\IdentitySet") || is_null($this->_propDict["final"])) {
    ...
    */
    public function getOriginal()
    {
        if (array_key_exists("original", $this->_propDict)) {
            if (is_a($this->_propDict["original"], "\Beta\Microsoft\Graph\Model\IdentitySet") || is_null($this->_propDict["original"])) {
