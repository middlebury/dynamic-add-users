    ...
    */
    public function getEnrollmentType()
    {
        if (array_key_exists("enrollmentType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentType"], "\Beta\Microsoft\Graph\Model\DeviceEnrollmentType") || is_null($this->_propDict["enrollmentType"])) {
    ...
    */
    public function getFailureCategory()
    {
        if (array_key_exists("failureCategory", $this->_propDict)) {
            if (is_a($this->_propDict["failureCategory"], "\Beta\Microsoft\Graph\Model\DeviceEnrollmentFailureReason") || is_null($this->_propDict["failureCategory"])) {
