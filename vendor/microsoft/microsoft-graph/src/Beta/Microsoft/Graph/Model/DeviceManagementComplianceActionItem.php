...
*
* DeviceManagementComplianceActionItem File
* PHP version 7
*
* @category  Library
...
/**
* DeviceManagementComplianceActionItem class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class DeviceManagementComplianceActionItem extends Entity
{
    /**
    * Gets the actionType
    ...
    *
    * @return DeviceManagementComplianceActionType|null The actionType
    */
    public function getActionType()
    {
        if (array_key_exists("actionType", $this->_propDict)) {
            if (is_a($this->_propDict["actionType"], "\Beta\Microsoft\Graph\Model\DeviceManagementComplianceActionType") || is_null($this->_propDict["actionType"])) {
                return $this->_propDict["actionType"];
            } else {
                $this->_propDict["actionType"] = new DeviceManagementComplianceActionType($this->_propDict["actionType"]);
                return $this->_propDict["actionType"];
            }
        }
        return null;
    ...
    * What action to take. Possible values are: noAction, notification, block, retire, wipe, removeResourceAccessProfiles, pushNotification, remoteLock.
    *
    * @param DeviceManagementComplianceActionType $val The actionType
    *
