    ...
    */
    public function getCategoryFilterGroups()
    {
        if (array_key_exists("categoryFilterGroups", $this->_propDict)) {
            if (is_a($this->_propDict["categoryFilterGroups"], "\Beta\Microsoft\Graph\Model\FilterGroup") || is_null($this->_propDict["categoryFilterGroups"])) {
    ...
    */
    public function getGroups()
    {
        if (array_key_exists("groups", $this->_propDict)) {
            if (is_a($this->_propDict["groups"], "\Beta\Microsoft\Graph\Model\FilterGroup") || is_null($this->_propDict["groups"])) {
    ...
    */
    public function getInputFilterGroups()
    {
        if (array_key_exists("inputFilterGroups", $this->_propDict)) {
            if (is_a($this->_propDict["inputFilterGroups"], "\Beta\Microsoft\Graph\Model\FilterGroup") || is_null($this->_propDict["inputFilterGroups"])) {
