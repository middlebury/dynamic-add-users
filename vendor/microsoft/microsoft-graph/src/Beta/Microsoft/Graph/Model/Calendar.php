...
class Calendar extends Entity
{
    ...
    *
    * @return string|null The calendarGroupId
    */
    ...
    */
    public function getColor()
    {
        if (array_key_exists("color", $this->_propDict)) {
            if (is_a($this->_propDict["color"], "\Beta\Microsoft\Graph\Model\CalendarColor") || is_null($this->_propDict["color"])) {
    ...
    */
    public function getDefaultOnlineMeetingProvider()
    {
        if (array_key_exists("defaultOnlineMeetingProvider", $this->_propDict)) {
            if (is_a($this->_propDict["defaultOnlineMeetingProvider"], "\Beta\Microsoft\Graph\Model\OnlineMeetingProviderType") || is_null($this->_propDict["defaultOnlineMeetingProvider"])) {
    ...
    *
    * @return bool|null The isSharedWithMe
    */
    ...
    */
    public function getOwner()
    {
        if (array_key_exists("owner", $this->_propDict)) {
            if (is_a($this->_propDict["owner"], "\Beta\Microsoft\Graph\Model\EmailAddress") || is_null($this->_propDict["owner"])) {
