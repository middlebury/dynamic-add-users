    ...
    */
    public function getApplicationIdentityType()
    {
        if (array_key_exists("applicationIdentityType", $this->_propDict)) {
            if (is_a($this->_propDict["applicationIdentityType"], "\Beta\Microsoft\Graph\Model\TeamworkApplicationIdentityType") || is_null($this->_propDict["applicationIdentityType"])) {
