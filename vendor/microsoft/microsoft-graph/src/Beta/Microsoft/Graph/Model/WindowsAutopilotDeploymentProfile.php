...
class WindowsAutopilotDeploymentProfile extends Entity
{
    ...
    *
    * @return WindowsAutopilotDeviceType|null The deviceType
    */
    ...
    *
    * @return bool|null The enableWhiteGlove
    */
    ...
    *
    * @return WindowsEnrollmentStatusScreenSettings|null The enrollmentStatusScreenSettings
    */
    ...
    *
    * @return bool|null The extractHardwareHash
    */
    ...
    *
    * @return OutOfBoxExperienceSettings|null The outOfBoxExperienceSettings
    */
