...
class ChangeNotificationCollection extends Entity
{
    ...
    *
    * @return string|null The validationTokens
    */
    ...
    *
    * @return ChangeNotification|null The value
    */
    public function getValue()
    {
        if (array_key_exists("value", $this->_propDict)) {
            if (is_a($this->_propDict["value"], "\Beta\Microsoft\Graph\Model\ChangeNotification") || is_null($this->_propDict["value"])) {
