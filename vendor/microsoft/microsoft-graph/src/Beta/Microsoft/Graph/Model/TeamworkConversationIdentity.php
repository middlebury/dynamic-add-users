    ...
    */
    public function getConversationIdentityType()
    {
        if (array_key_exists("conversationIdentityType", $this->_propDict)) {
            if (is_a($this->_propDict["conversationIdentityType"], "\Beta\Microsoft\Graph\Model\TeamworkConversationIdentityType") || is_null($this->_propDict["conversationIdentityType"])) {
