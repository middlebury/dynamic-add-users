    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "\Beta\Microsoft\Graph\Model\RecentNotebookLinks") || is_null($this->_propDict["links"])) {
    ...
    */
    public function getSourceService()
    {
        if (array_key_exists("sourceService", $this->_propDict)) {
            if (is_a($this->_propDict["sourceService"], "\Beta\Microsoft\Graph\Model\OnenoteSourceService") || is_null($this->_propDict["sourceService"])) {
