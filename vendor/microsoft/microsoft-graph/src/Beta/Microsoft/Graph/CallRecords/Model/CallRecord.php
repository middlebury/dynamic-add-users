...
class CallRecord extends \Beta\Microsoft\Graph\Model\Entity
{
    ...
    *
    * @return \Beta\Microsoft\Graph\Model\IdentitySet|null The organizer
    */
    ...
    */
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "\Beta\Microsoft\Graph\CallRecords\Model\CallType") || is_null($this->_propDict["type"])) {
