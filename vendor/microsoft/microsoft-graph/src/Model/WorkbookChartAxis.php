    ...
    */
    public function getFormat()
    {
        if (array_key_exists("format", $this->_propDict)) {
            if (is_a($this->_propDict["format"], "\Microsoft\Graph\Model\WorkbookChartAxisFormat") || is_null($this->_propDict["format"])) {
    ...
    */
    public function getMajorGridlines()
    {
        if (array_key_exists("majorGridlines", $this->_propDict)) {
            if (is_a($this->_propDict["majorGridlines"], "\Microsoft\Graph\Model\WorkbookChartGridlines") || is_null($this->_propDict["majorGridlines"])) {
    ...
    */
    public function getMinorGridlines()
    {
        if (array_key_exists("minorGridlines", $this->_propDict)) {
            if (is_a($this->_propDict["minorGridlines"], "\Microsoft\Graph\Model\WorkbookChartGridlines") || is_null($this->_propDict["minorGridlines"])) {
    ...
    */
    public function getTitle()
    {
        if (array_key_exists("title", $this->_propDict)) {
            if (is_a($this->_propDict["title"], "\Microsoft\Graph\Model\WorkbookChartAxisTitle") || is_null($this->_propDict["title"])) {
