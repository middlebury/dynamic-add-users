    ...
    */
    public function getChangedBy()
    {
        if (array_key_exists("changedBy", $this->_propDict)) {
            if (is_a($this->_propDict["changedBy"], "\Microsoft\Graph\Model\IdentitySet") || is_null($this->_propDict["changedBy"])) {
    ...
    */
    public function getStageStatus()
    {
        if (array_key_exists("stageStatus", $this->_propDict)) {
            if (is_a($this->_propDict["stageStatus"], "\Microsoft\Graph\Model\SubjectRightsRequestStageStatus") || is_null($this->_propDict["stageStatus"])) {
