    ...
    */
    public function getEventLocation()
    {
        if (array_key_exists("eventLocation", $this->_propDict)) {
            if (is_a($this->_propDict["eventLocation"], "\Microsoft\Graph\Model\Location") || is_null($this->_propDict["eventLocation"])) {
    ...
    */
    public function getEventStartTime()
    {
        if (array_key_exists("eventStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["eventStartTime"], "\Microsoft\Graph\Model\DateTimeTimeZone") || is_null($this->_propDict["eventStartTime"])) {
    ...
    */
    public function getReminderFireTime()
    {
        if (array_key_exists("reminderFireTime", $this->_propDict)) {
            if (is_a($this->_propDict["reminderFireTime"], "\Microsoft\Graph\Model\DateTimeTimeZone") || is_null($this->_propDict["reminderFireTime"])) {
