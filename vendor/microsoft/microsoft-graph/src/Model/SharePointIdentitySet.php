    ...
    */
    public function getGroup()
    {
        if (array_key_exists("group", $this->_propDict)) {
            if (is_a($this->_propDict["group"], "\Microsoft\Graph\Model\Identity") || is_null($this->_propDict["group"])) {
    ...
    */
    public function getSiteGroup()
    {
        if (array_key_exists("siteGroup", $this->_propDict)) {
            if (is_a($this->_propDict["siteGroup"], "\Microsoft\Graph\Model\SharePointIdentity") || is_null($this->_propDict["siteGroup"])) {
    ...
    */
    public function getSiteUser()
    {
        if (array_key_exists("siteUser", $this->_propDict)) {
            if (is_a($this->_propDict["siteUser"], "\Microsoft\Graph\Model\SharePointIdentity") || is_null($this->_propDict["siteUser"])) {
